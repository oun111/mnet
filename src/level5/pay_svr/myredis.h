...
extern int myredis_read(myredis_t mr, const char *table, const char *key, dbuffer_t *value);

extern int myredis_write(myredis_t mr, const char *table, char *key, char *value, int st);
