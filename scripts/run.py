...
if opt=="0" or opt=="1":
  ...
  if opt=="1":
     ...
     os.system("./src/mstore_test -l ./modules/ -cp ./conf/paysvr_conf.json  -cm ./conf/mp2_conf.json -cj ./conf/myjvm_conf.json -mF {0} -mC {1} -mW {2} {3} ".format(logFlushInterval,numConnections,numWorkers,logToFile))
